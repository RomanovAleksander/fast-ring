...
`app/debug.keystore` лежить у git навмисно. Інакше кожна машина (і кожен
runner у CI) створює власний debug-ключ, підпис у кожної збірки різний,
Android відмовляється оновлювати встановлений застосунок — і єдиний спосіб
поставити нову версію це видалити стару разом з базою та налаштуваннями.
Debug-ключ нічого не публікує; пароль стандартний (`android`).
